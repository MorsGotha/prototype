    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td style="color: green;"><button  id="engineer" type="button" class="btn btn-default">Edit</button> OK</td>
                <td>
                    <div class="btn-group">
            ...
            <tr class='alt'>
                ...
                <td style="color: red;"><button  id="engineer" type="button" class="btn btn-default">Edit</button> Unsurveyed</td>
                <td>
                    <div class="btn-group">
                        <button id="add" type="button" class="btn btn-default">Edit</button>
                        <button id="add" type="button" class="btn btn-default">Revise</button>
            ...
            <tr class='alt'>
                ...
                <td style="color: orange;"><button  id="engineer" type="button" class="btn btn-default">Edit</button> Unassigned plots</td>
                <td>
                    <div class="btn-group">
                        <button id="add"  type="button" class="btn btn-default">Edit</button>
                        <button id="add"  type="button" class="btn btn-default">Revise</button>
...
<script>
$(document).ready("#engineer").click(function() {
      window.location = "?main=technical&sub=engineerplots"
});
$(document).ready("#add").click(function() {
      window.location = "?main=technical&sub=editplots"
});
</script>