...
<div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title">Reserved Prices</h3>
    </div>
    <table class="table">
        <thead>
            <th>SITE</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>15</td>
                <td>JONES</td>
                <td>&pound;195,000.00</td>
            </tr>
        </tbody>
    </table>
    
<div class="page-header">
    <h3>Welcomes to Davidsons Application Prototype - Sales Dashboard</h3>
</div>
