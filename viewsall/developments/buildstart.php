<ol class="breadcrumb">
  ...
  <li class="active">Build Start</li>
</ol>

<div class="col-xs-12 pull-right">
    
    <div class="panel panel-default">
      <div class="panel-heading">Welcome to Davidsons Application Prototype - Build Start</div>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-group">
                                    <input id="date-picker-1" type="text" class="date-picker form-control" value="07/06/2014" disabled />
                ...
                <tr class="alt">
                    ...
                    <td>
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-group">
                                    <input id="date-picker-1" type="text" class="date-picker form-control" value="21/06/2014" disabled />
                                    <label for="date-picker-1" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span>
                                </div>
                            </div>
                        </div>
                ...
                <tr class="alt">
                    ...
                    <td>
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-group">
                                    <input id="date-picker-1" type="text" class="date-picker form-control" value="" />
                                    <label for="date-picker-1" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span>
                                </div>
                            </div>
                        </div>
